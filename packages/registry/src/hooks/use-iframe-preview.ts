...
// `min-h-screen` on host pages. Exported so ResponsiveFrameView (which has
// its own inline iframe-loading path) can use the same injection.
export const PREVIEW_HIDE_CHROME_CSS = `
